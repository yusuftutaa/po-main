                              ...
                              <div class="row">
                                <div class="col-md-4 align-self-start pl-4 pr-4">
                                  ...
                                  <?php
                                    ...
                                    $disabled = $id_role != 1 ? "disabled" :"";
                                  ?>
                                  <select <?php echo $disabled; ?> class="form-control" id="filter_group">
                                    ...
                                    <?php
                                      ...
                                      while($row = $query->fetch(PDO::FETCH_ASSOC)){
                                        $selected = "";
                                        if($id_role != 1){
                                          $selected = $result['id_role'] == $row['id_role'] ? "selected" :"";
                                        }
                                ...
                                <div class="col-md-4 pl-4 pr-4">
                                  ...
                                  <select class="form-control" id="filter_status">
                                    <option value=''>Semua</option>
                                    <?php
                                      $sqql = "SELECT status FROM tb_status";
                                      $arr_status = array($sqql);
                                      $i = 0;
...
<script>
  ...
  var group= $("#filter_group option:selected").val();
